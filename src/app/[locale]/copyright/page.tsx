...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Dragon Ball Xenoverse 2 Wiki',
    description: 'Copyright and intellectual property information for Dragon Ball Xenoverse 2 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Dragon Ball Xenoverse 2 Wiki',
      description: 'Copyright and intellectual property information for Dragon Ball Xenoverse 2 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Dragon Ball Xenoverse 2 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Dragon Ball Xenoverse 2 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Dragon Ball Xenoverse 2 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Bandai Namco Entertainment</strong> - Publisher of Dragon Ball Xenoverse 2</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Dragon Ball Xenoverse 2</strong> - Trademark of Bandai Namco Entertainment</li>
              <li><strong>Dragon Ball Xenoverse 2 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Dragon Ball Xenoverse 2 Wiki.
            </p>
            ...
            <p>
              ...
              Dragon Ball Xenoverse 2 Wiki<br />
              Email: <a href="mailto:dmca@dragon-ball-xenoverse-2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@dragon-ball-xenoverse-2.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Dragon Ball Xenoverse 2 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Dragon Ball Xenoverse 2 Wiki (dragon-ball-xenoverse-2.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@dragon-ball-xenoverse-2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@dragon-ball-xenoverse-2.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@dragon-ball-xenoverse-2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@dragon-ball-xenoverse-2.wiki</a>
            </p>
            <p>
